...
$tdatastudent_subject[".pagesByType"] = my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" );
$tdatastudent_subject[".originalPagesByType"] = $tdatastudent_subject[".pagesByType"];
$tdatastudent_subject[".pages"] = types2pages( my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" ) );
$tdatastudent_subject[".originalPages"] = $tdatastudent_subject[".pages"];
$tdatastudent_subject[".defaultPages"] = my_json_decode( "{\"list\":\"list\",\"search\":\"search\"}" );
...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelsstudent_subject["English"]["student"] = "Student";
	$fieldToolTipsstudent_subject["English"]["student"] = "";
	$placeHoldersstudent_subject["English"]["student"] = "";
	$fieldLabelsstudent_subject["English"]["subject"] = "Subject";
	$fieldToolTipsstudent_subject["English"]["subject"] = "";
	$placeHoldersstudent_subject["English"]["subject"] = "";
...
$tdatastudent_subject[".badgeColor"] = "9acd32";
...
$tdatastudent_subject[".googleLikeFields"][] = "student";
$tdatastudent_subject[".googleLikeFields"][] = "subject";
...
$tdatastudent_subject[".sqlHead"] = "SELECT id,  	student,  	subject";
...
//	Custom field settings
	...
	$fdata["ownerTable"] = "student_subject";
	$fdata["Label"] = GetFieldLabel("student_subject","student");
	$fdata["FieldType"] = 3;
...
//end of Filters settings
	...
	$tdatastudent_subject["student"] = $fdata;
		$tdatastudent_subject[".searchableFields"][] = "student";
//	subject
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 3;
	...
	$fdata["ownerTable"] = "student_subject";
	$fdata["Label"] = GetFieldLabel("student_subject","subject");
	$fdata["FieldType"] = 3;
...
//end of Filters settings
	...
	$tdatastudent_subject["subject"] = $fdata;
		$tdatastudent_subject[".searchableFields"][] = "subject";
...
$masterTablesData["student_subject"] = array();
	...
	$masterTablesData["student_subject"][0]["detailKeys"][]="student";
	...
	$masterTablesData["student_subject"][1]["detailKeys"][]="subject";
...
$proto0["m_strFieldList"] = "id,  	student,  	subject";
