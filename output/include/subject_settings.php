...
$tdatasubject[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatasubject[".originalPagesByType"] = $tdatasubject[".pagesByType"];
$tdatasubject[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatasubject[".originalPages"] = $tdatasubject[".pages"];
$tdatasubject[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"export\":\"export\",\"import\":\"import\",\"list\":\"list\",\"masterlist\":\"masterlist\",\"masterprint\":\"masterprint\",\"print\":\"print\",\"search\":\"search\",\"view\":\"view\"}" );
...
//	student_subject
		...
		$dIndex = 0;
	$detailsParam = array();
	$detailsParam["dDataSourceTable"]="student_subject";
		$detailsParam["dOriginalTable"] = "student_subject";



		
		$detailsParam["dType"]=PAGE_LIST;
	$detailsParam["dShortTable"] = "student_subject";
	$detailsParam["dCaptionTable"] = GetTableCaption("student_subject");
	$detailsParam["masterKeys"] =array();
	$detailsParam["detailKeys"] =array();


		
	$detailsTablesData["subject"][$dIndex] = $detailsParam;

	
		$detailsTablesData["subject"][$dIndex]["masterKeys"] = array();

	$detailsTablesData["subject"][$dIndex]["masterKeys"][]="id";

				$detailsTablesData["subject"][$dIndex]["detailKeys"] = array();

	$detailsTablesData["subject"][$dIndex]["detailKeys"][]="subject";
//endif
