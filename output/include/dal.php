...
class tDAL
{
	...
	var $tbldb_administration_at_localhost__student_subject;
	...
	function FillTablesList()
	{
		...
		$this->lstTables[] = array("name" => "student_subject", "varname" => "db_administration_at_localhost__student_subject", "altvarname" => "student_subject", "connId" => "db_administration_at_localhost", "schema" => "", "connName" => "db_administration at localhost");
