	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "db_administration_at_localhost" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "student_subject", "varname" => "db_administration_at_localhost__student_subject", "altvarname" => "student_subject", "connId" => "db_administration_at_localhost", "schema" => "", "connName" => "db_administration at localhost");
